            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Incoming Items</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Incoming Items</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                         $getAllData = mysqli_query($conn, 'SELECT *FROM `item-in` m, `stock` s where s.`id-item` = m.`id-item` ');
