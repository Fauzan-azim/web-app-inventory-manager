...
<!DOCTYPE html>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="Dashboard.php">Inventory Management</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Outgoing Items</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Outgoing Items</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                         $getAllData = mysqli_query($conn, 'SELECT *FROM `item-out` m, `stock` s where s.`id-item` = m.`id-item` ');
