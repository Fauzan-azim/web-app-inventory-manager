            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Incoming Records</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                         $getAllData = mysqli_query($conn, 'SELECT *FROM `item-in` m, `inventories` s where s.`id-item` = m.`id-item` ');
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$qty;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idin;?>">
                                                    Edit
                                                </button>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idin;?>">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
                                            <!-- Edit Modal -->
                                        <div class="modal fade" id="edit<?=$idin;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <button type="submit" name="UpdateIncomeItem" class="btn btn-primary">Submit</button>
                                                    </div>
                                                </form>
                                            ...
                                            <!-- Delete Modal -->
                                          <div class="modal fade" id="delete<?=$idin;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <button type="submit" name="DeleteIncomeItem" class="btn btn-danger">Delete</button>
                                                    </div>
                                                </form>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form method="post">
            ...
            <button type="submit" name="item-in" class="btn btn-primary">Submit</button>
            </div>
        </form>
        <!-- Modal footer -->
